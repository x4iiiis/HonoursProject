...
Documentation/tutorial file in Appendix G.\\
...
The code for human vs neural play IS there, but the problems with SFML when switching to the mac removed that playability. Hopefully in future I'll be able to incorporate the mac version of SFML to this project, and allow for human vs AI gameplay. It probably wouldn't take much to fix but the switch had cost me enough time as it was without trying to figure that out too. \\

It would also be cool to implement neural vs neural, but unfortunately we ran out of time for that. Again, I'd imagine it'd be pretty simple. Just create a "Neural2" playstyle for players, and copy and paste the neural rules from Game.h and change Neural to Neural2. Of course, I'd also need to create a second network and pass that in from NEAT to my game. 

Tbh I might try it just to say like I've done this but didn't have time to properly guage results. Maybe I'll just run one massive fuckin test with it and be like bruh take it or leave it  
...
Insert gantt charts here

\newpage
\section{My Website}
\href{http://www.x4iiiis.com/honoursproject}
{\includegraphics[width=\textwidth]{Website.jpg}}
